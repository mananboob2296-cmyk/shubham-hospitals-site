...
export interface AboutContent {
  ...
  whyH2: string; whyLead: string; whyCards: { h: string; p: string }[]; founder: string;
...
export const aboutContent: Record<Lang, AboutContent> = {
  en: {
    ...
    statLabels: ['Total Patients', 'Laparoscopic Surgeries', 'Years of Experience', 'IVF Babies'],
    ...
    whyCards: [
      { h: 'Qualified Doctors', p: '45 years of combined experience across our senior consultants.' },
      { h: 'Online Consultation', p: 'Book an online appointment with your specialist doctor.' },
  ...
  hi: {
    ...
    p1: 'एक साधारण प्रसूति एवं सर्जिकल देखभाल केंद्र के रूप में शुरू होकर, शुभम हॉस्पिटल्स एक मल्टीस्पेशलिटी केंद्र बन गया है जो उन्नत लेप्रोस्कोपी, हिस्टेरोस्कोपी, आईवीएफ, प्रजनन उपचार, हाई-रिस्क प्रसूति और कॉस्मेटिक गायनेकोलॉजी सहित अत्याधुनिक उपचार देता है। लगभग तीन दशकों की उत्कृष्टता के साथ, यह क्षेत्र के सबसे भरोसेमंद नामों में से एक बन गया है।',
    ...
    statLabels: ['कुल मरीज़', 'लेप्रोस्कोपिक सर्जरी', 'वर्षों का अनुभव', 'आईवीएफ शिशु'],
    ...
    expH2: 'हमारा अनुभव', expP: 'लगभग 30 वर्षों की समर्पित सेवा के साथ, शुभम हॉस्पिटल्स ने स्वास्थ्य सेवा में एक भरोसेमंद नाम बनाया है। 1995 में डॉ. मुरलीधर बूब और डॉ. मंजूश्री बूब द्वारा स्थापित, यह अस्पताल एक साधारण प्रसूति एवं सर्जिकल देखभाल केंद्र के रूप में शुरू हुआ और अब एक अग्रणी मल्टीस्पेशलिटी सुविधा बन गया है। वर्षों में हमने उन्नत लेप्रोस्कोपी, हिस्टेरोस्कोपी, आईवीएफ, प्रजनन उपचार, हाई-रिस्क प्रसूति और कॉस्मेटिक गायनेकोलॉजी में व्यापक अनुभव प्राप्त किया है।',
    ...
    whyCards: [
      { h: 'योग्य डॉक्टर', p: 'हमारे वरिष्ठ सलाहकारों का 45 वर्षों का संयुक्त अनुभव।' },
      { h: 'ऑनलाइन परामर्श', p: 'अपने विशेषज्ञ डॉक्टर से ऑनलाइन अपॉइंटमेंट बुक करें।' },
  ...
  mr: {
    ...
    statLabels: ['एकूण रुग्ण', 'लॅपरोस्कोपिक शस्त्रक्रिया', 'वर्षांचा अनुभव', 'आयव्हीएफ बाळे'],
    vmH2: 'दृष्टी व ध्येय',
    ...
    whyCards: [
      { h: 'पात्र डॉक्टर', p: 'आमच्या ज्येष्ठ सल्लागारांचा 45 वर्षांचा एकत्रित अनुभव.' },
      { h: 'ऑनलाइन सल्ला', p: 'तुमच्या तज्ज्ञ डॉक्टरांची ऑनलाइन अपॉइंटमेंट बुक करा.' },
