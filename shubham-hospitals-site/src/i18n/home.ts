...
export const homeStrings: Record<Lang, HomeStrings> = {
  en: {
    ...
    heroH1: 'Trusted IVF, 3D Laparoscopy & Maternity Care in Amravati',
  ...
  hi: {
    ...
    heroH1: 'अमरावती में भरोसेमंद आईवीएफ, 3D लेप्रोस्कोपी एवं प्रसूति देखभाल',
  ...
  mr: {
    ...
    heroH1: 'अमरावतीतील विश्वासार्ह आयव्हीएफ, 3D लॅपरोस्कोपी व प्रसूती काळजी',
